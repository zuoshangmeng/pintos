               ...
               thread_func *function, void *aux) 
{
  ...
  /*modify by team5 qiaoqi for priority_change priority_preempt*/
...
/*modify by team5 houxin for alarm-clock*/
  t->ticks_blocked = 0;
/*modify e*/  
  return tid;
}
...
{
  /*modify by team5 gaoganyu for priority-priority-* */
  if(thread_mlfqs)
    return;
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  /*modify e*/
  /*add by team5 gaoganyu for priority-priority-* */
